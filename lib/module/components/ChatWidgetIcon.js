...
import { SDKPressable } from "./ui/index.js";
...
export const ChatWidgetIcon = ({
  ...
  const imageSource = iconUri ? typeof iconUri === 'string' ? {
    uri: iconUri
  } : iconUri : require('../assets/icons/chatWidget.png');
  useEffect(() => {
  ...
  return /*#__PURE__*/_jsxs(View, {
    ...
    children: [/*#__PURE__*/_jsx(SDKPressable, {
      onPress: onPress,
